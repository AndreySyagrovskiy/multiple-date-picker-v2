        ...
        return {
            ...
            link: function (scope) {
                    ...
                    if (momentDate.selectable && !prevented) {
                        ...
                        if(event.shiftKey) {
                            ...
                            if(scope.convertedDaysSelected.length === 0) {
                                ...
                                let dateStart = null;
                                let dateEnd   = null;
                                if(scope.convertedDaysSelected[0].valueOf() < momentDate.valueOf()){
                                    dateStart = scope.convertedDaysSelected[0];
                                    dateEnd   = momentDate;
                                } else {
				...
				scope.convertedDaysSelected = [];
                    ...
                    scope.daysSelected = _.map( scope.convertedDaysSelected, val => val.valueOf());
                };
